...
//[Serializer(typeof(RuntimeAnimatorController))]
//public class SerializeAnimatorController : SerializerExtensionBase<RuntimeAnimatorController>
//{
//    public override IEnumerable<object> Save(RuntimeAnimatorController target)
//    {
//        return new object[] { target.name };
//    }
...
//    public override object Load(object[] data, object instance)
//    {
//        var uo = UnitySerializer.DeserializedObject;
//        return new UnitySerializer.DeferredSetter (d => {
//            //var p = uo.GetType().GetProperty
//            return null;
//        });
//    }
//}
...
//public class SerializeAnimator : IComponentSerializer
//{
...
//        public AnimatorInfo(Animator source)
//        {
//            controller = source.runtimeAnimatorController;
//            applyRootMotion = source.applyRootMotion;
...
//    public byte[] Serialize(Component component)
//    {
//        return UnitySerializer.Serialize(new AnimatorInfo((Animator)component));

//    }

//    public void Deserialize(byte[] data, Component instance)
//    {
//        var info = UnitySerializer.Deserialize<AnimatorInfo>(data);
//        info.Configure((Animator)instance);
//        UnitySerializer.AddFinalAction(() =>
//        {
//            info.Configure((Animator)instance);
//        });
